...
| stopBluetoothDevicesDiscovery  |  func   |    否    | 微信蓝牙设备结束扫描，默认使用wx.stopBluetoothDevicesDiscovery，如果该方法在其他地方有使用，则需要你自己去避免冲突    |
| startBluetoothDevicesDiscovery |  func   |    否    | 微信蓝牙开始扫描，默认使用wx.startBluetoothDevicesDiscovery，如果该方法在其他地方有使用，则需要你自己去避免冲突        |
